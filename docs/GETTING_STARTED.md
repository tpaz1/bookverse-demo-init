...
export JFROG_URL="https://tompazus.jfrog.io"
...
#    - JFrog Platform Host: https://tompazus.jfrog.io
...
gh workflow run "🔄-switch-platform.yml" \
  --field jpd_host="https://tompazus.jfrog.io" \
...
```bash
cd bookverse-demo-init
export REGISTRY_SERVER='tompazus.jfrog.io'       # JFrog hostname (without https://)
...
echo $JFROG_URL  # Should be: https://tompazus.jfrog.io
